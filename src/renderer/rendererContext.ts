...
const rendererContext = {
  ...
  addToAnki: (context: string, word_indexes: number[], explanation: string,deckName:string,includeCloze:boolean, includeQACard:boolean) => {return ipcRenderer.invoke('addToAnki',context,word_indexes,explanation,
    deckName,includeCloze, includeQACard)},
